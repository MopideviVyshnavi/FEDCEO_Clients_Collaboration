...
class LocalUpdate(object):
    ...
    def train_val_test(self, dataset, idxs):
        ...
        and user indexes.
        """
        # split indexes for train, validation, and test (0.8, 0.1, 0.1)
    ...
    def update_weights(self, model, global_round, args):
        ...
        if self.args.privacy == True:
            ...
            if self.args.verbose:
                print('The gaussian-DP is adopted!')
    ...
    def inference(self, model):
        ...
        for batch_idx, (images, labels) in enumerate(self.testloader):
            ...
            for c in range(self.args.num_classes):
                class_correct[c] += torch.sum((pred_labels == c) & (labels == c)).item()
        ...
        per_class_accuracy = [class_correct[c] / class_total[c] if class_total[c] > 0 else 0 for c in range(self.args.num_classes)]
        
        return accuracy, loss, per_class_accuracy
