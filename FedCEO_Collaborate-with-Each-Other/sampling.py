...
# EMNIST
# random select the same number of datas in equal P (uniform distribution)
...
def emnist_noniid(dataset, num_users):
    ...
    # random select 60000 images from train data
    num_samples = 60000
    ...
    # 600,000 training imgs -->  300 imgs/shard X 200 shards
...
def emnist_noniid_unequal(dataset, num_users):
    """
    Sample non-I.I.D client data from EMNIST dataset s.t clients
    ...
    # 600,000 training imgs --> 50 imgs/shard X 1200 shards
